...
class CustomBertEmbeddings(nn.Module):
    ...
    def forward(
        self, input_ids=None, token_type_ids=None, position_ids=None, entity_loc_ids=None, entity_type_ids=None, inputs_embeds=None, past_key_values_length=0
    ):
        ...
        if entity_loc_ids is not None:
            ...
            embeddings += entity_loc_embeddings
...
class CustomElectraEmbeddings(nn.Module):
    """Construct the embeddings from word, position and token_type embeddings."""
